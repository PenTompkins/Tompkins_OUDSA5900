#This file is being created to run SVR for most all OT data (besides Amazon and BMW)
#with sentiment added in
#But only Disney worked (errored out at Mercredes)
...
write_xlsx(df, "C:\\Users\\taylo\\OneDrive\\Documents\\TwitterProject\\ModelingResults_OT\\Storage\\SVR_Disney_OT2.xlsx")
