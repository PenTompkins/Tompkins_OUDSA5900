#This file is being created to run BTM topic effect val. process over CocaCola IRT tweets
#
...
data = read_excel("C:/Users/Pendl/OneDrive/Documents/TwitterProject/Pictures/BTMresults_IRT/CocaCola_BTMresults_IRT.xlsx")
...
df = tibble(gr = factor(c(rep("Zero", nt0), rep("One", nt1), rep("Two", nt2))),
