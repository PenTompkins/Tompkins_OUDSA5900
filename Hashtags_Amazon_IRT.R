#This file is being created to run hashtag effect val. process over Amazon IRT tweets
#
...
data = read_excel("C:/Users/Pendl/OneDrive/Documents/TwitterProject/OutlierFree_data/Amazon_outsRemoved.xlsx")
...
ggdensity(Hashtag_tweets$logLikes,
          main = "Amazon Hashtags: log(Likes)",
...
ggdensity(noHashtag_tweets$logLikes,
          main = "Amazon No Hashtag: log(Likes)",
...
ggdensity(noHashtag_tweets$`Number of Retweets`,
          main = "Amazon No Hashtag: Retweets",
