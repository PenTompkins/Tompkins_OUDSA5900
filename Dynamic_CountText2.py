# -*- coding: utf-8 -*-
#This file is being created to perform 'Dynamic_CountText.py' process, but with lemmatization as an included step
#Otherwise, the file should be exactly the same (except for "u" being included as a stop word)
#!Note: Due to time constraints, this program has not been used in any analysis
#Overall, this is program: 32
...
stop_words.add("wed")
stop_words.add("us")
#For lemmatized versions, also include:
stop_words.add("u")
