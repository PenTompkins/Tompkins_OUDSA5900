#This file is being created to run link effect val. process over McDonalds IRT tweets
#
...
ggdensity(link_tweets$logLikes,
          main = "McDonalds Linked: log(Likes)",
...
ggdensity(noLink_tweets$logLikes,
          main = "McDonalds No Link: log(Likes)",
          xlab = "log(Likes)")
...
ggdensity(link_tweets$`Number of Retweets`,
          main = "McDonalds Linked: Retweets",
...
ggdensity(noLink_tweets$`Number of Retweets`,
          main = "McDonalds No Link: Retweets",
...
ggdensity(noLink_tweets$logRetweets,
          main = "McDonalds No Link: log(RTs)",
          xlab = "log(Retweets)")
