# -*- coding: utf-8 -*-
#This file is being created to improve upon 'BTM_model1.py'
#I'm beginning by copying/pasting said file in here, then including code to assign tweets as OT vs. IRT
#Furthermore, I'm making changes such that tweet 'Contents' in saved files match exactly with tweet contents input to this program
#Additionally, I'm making it such that tweet 'topic' saves to excel as a numeric value, not as a string
#
#Overall, this is program: 43
...
respath = 'C:\\Users\\Pendl\\OneDrive\\Documents\\TwitterProject\\Pictures\\BTMresults2\\'
resEnding = '_BTMresults2.xlsx'
#optKs = [6, 8, 10, 10, 6, 10, 11, 6, 8, 10] #optKs for BTM_model1.py
optKs = [5, 4, 4, 16, 3, 6, 13, 15, 6, 19]
...
print("Performing BTM across all 10 companies took %s seconds" % global_run)
