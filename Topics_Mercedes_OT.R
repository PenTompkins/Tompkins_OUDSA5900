#This file is being created to run BTM topic effect val. process over Mercedes OT tweets
#
...
data = read_excel("C:/Users/Pendl/OneDrive/Documents/TwitterProject/Pictures/BTMresults_OT/MercedesBenz_BTMresults_OT.xlsx")

#No need to separate OT/IRT, already done in data
tweets = data
#OT Tweet Likes Analysis:
##################################################################################################################
#Regular:
...
df = tibble(gr = factor(c(rep("Zero", nt0), rep("One", nt1), rep("Two", nt2), rep("Three", nt3),
                          rep("Four", nt4), rep("Five", nt5), rep("Six", nt6), rep("Seven", nt7),
                          rep("Eight", nt8), rep("Nine", nt9), rep("Ten", nt10))),
            obs = c(top0$`Number of Likes`, top1$`Number of Likes`, top2$`Number of Likes`, top3$`Number of Likes`,
                    ...
                    top8$`Number of Likes`, top9$`Number of Likes`, top10$`Number of Likes`))
...
df = tibble(gr = factor(c(rep("Zero", nt0), rep("One", nt1), rep("Two", nt2), rep("Three", nt3),
            ...
            obs = c(top0$logLikes, top1$logLikes, top2$logLikes, top3$logLikes,
                    ...
                    top8$logLikes, top9$logLikes, top10$logLikes))
...
df = tibble(gr = factor(c(rep("Zero", nt0), rep("One", nt1), rep("Two", nt2), rep("Three", nt3),
            ...
            obs = c(top0$`Number of Retweets`, top1$`Number of Retweets`, top2$`Number of Retweets`, top3$`Number of Retweets`,
                    ...
                    top8$`Number of Retweets`, top9$`Number of Retweets`, top10$`Number of Retweets`))
...
df = tibble(gr = factor(c(rep("Zero", nt0), rep("One", nt1), rep("Two", nt2), rep("Three", nt3),
            ...
            obs = c(top0$logRetweets, top1$logRetweets, top2$logRetweets, top3$logRetweets,
                    ...
                    top8$logRetweets, top9$logRetweets, top10$logRetweets))
