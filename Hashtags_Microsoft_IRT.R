#This file is being created to run hashtag effect val. process over Microsoft IRT tweets
#
...
data = read_excel("C:/Users/Pendl/OneDrive/Documents/TwitterProject/OutlierFree_data/Microsoft_outsRemoved.xlsx")
...
ggdensity(noHashtag_tweets$`Number of Likes`,
          main = "Microsoft No Hashtag: Likes",
...
ggdensity(Hashtag_tweets$logLikes,
          main = "Microsoft Hashtags: log(Likes)",
...
ggdensity(noHashtag_tweets$logLikes,
          main = "Microsoft No Hashtag: log(Likes)",
...
ggdensity(Hashtag_tweets$`Number of Retweets`,
          main = "Microsoft Hashtags: Retweets",
...
ggdensity(noHashtag_tweets$`Number of Retweets`,
          main = "Microsoft No Hashtag: Retweets",
