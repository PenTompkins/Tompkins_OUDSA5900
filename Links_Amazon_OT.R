#This file is being created to run link effect val. process over Amazon OT tweets
#
#Overall, this is program: 69
...
sf = shifthd_pbci(data = df, formula = obs ~ gr) #use version of shift which works better for tied vals.
sf
