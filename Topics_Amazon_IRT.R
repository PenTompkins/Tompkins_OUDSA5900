#This file is being created to run BTM topic effect val. process over Amazon IRT tweets
#
...
data = read_excel("C:/Users/Pendl/OneDrive/Documents/TwitterProject/Pictures/BTMresults_IRT/Amazon_BTMresults_IRT.xlsx")
