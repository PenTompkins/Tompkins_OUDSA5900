# -*- coding: utf-8 -*-
#This file is being created to improve upon the 'estimate_BTM.py' process
#BTM estimation can be sped up further, making it possible to examine more values of k per company
#I'm beginning by copying/pasting 'LongEstimateBTM.py' into this file, then including Amazon and BMW in the list of files
#Afterwards, I'll speed up the 'speedyBTM' function and test all potential k values for all companies
##!I've changed 'figpath' so that original plots are preserved in future runs
##Since 'visualizeBTM.py' doesn't seem to be working, I'm going to try to overlay the silhouette scores here, within this file
##So, I'll copy/paste the silhouette scores, then add code to the figures to overlay silhouette scores
##!!!Actually, I'm going to do all that in 'approximate_BTM2.py'
#
#Overall, this is program: 42
