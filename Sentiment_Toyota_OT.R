#This file is being created to run sentiment effect val. process over Toyota OT tweets
#
...
data = read_excel("C:/Users/Pendl/OneDrive/Documents/TwitterProject/OutlierFree_data/withSentiment/Toyota_outsRem_ws.xlsx")
...
ggdensity(pos_tweets$logLikes,
          main = "Toyota Positive: log(Likes)",
...
ggdensity(neg_tweets$logLikes,
          main = "Toyota Negative: log(Likes)",
          xlab = "log(Likes)") #+ xlim(0, max(noHashtag_tweets$`Number of Likes`))
...
ggdensity(pos_tweets$logRetweets,
          main = "Toyota Positive: log(Retweets)",
...
ggdensity(neut_tweets$logRetweets,
          main = "Toyota Neutral: log(Retweets)",
...
ggdensity(neg_tweets$logRetweets,
          main = "Toyota Negative: log(Retweets)",
