# -*- coding: utf-8 -*-
#This file is being created to perform the 'Dynamic_CountAll.py' process, but with lemmatization as an included step
#Otherwise, this file should be exactly the same
#
#Overall, this is program: 31
...
stop_words.add("wed")
stop_words.add("us")
#For lemmatized version, also include:
stop_words.add("u")
...
if propOT >= minThresh and propIRT >= minThresh:
    ...
    #For this version, perform lemmatization on the official tweets:
    ...
    print(company_name)
    print("Number of top OT tweets: %s" % len(top_official["Content"]))
    ...
    print(company_name)
    print("Total number of median OT tweets: %s" % len(midTweets_OT["Content"]))
    ...
    #print(len(VOCAB_topOT))
    print(company_name)
    print("Total number of bottom 25pct OT tweets: %s" % len(bottom_official["Content"]))
    ...
    #print(len(VOCAB_topOT))
    print(company_name)
    print("Total number of top 25pct IRT tweets: %s" % len(top_IRT["Content"]))
...
#In the case that there aren't enough official tweets for analysis:
    ...
    print("%s doesn't seem to have enough official tweets for analysis. All tweets will be used, these are mostly IRT" % company_name)
    ...
    #print(len(VOCAB_topOT))
    print(company_name)
    print("Total number of top tweets: %s" % len(top_IRT["Content"]))
    ...
    #print(len(VOCAB_topOT))
    print(company_name)
    print("Total number of bottom tweets: %s" % len(bottom_IRT["Content"]))
...
#In case there aren't enough IRT tweets for analysis:
    ...
    #print(len(VOCAB_topOT))
    print(company_name)
    print("Total number of top tweets: %s" % len(top_official["Content"]))
    ...
    #print(len(VOCAB_topOT))
    print(company_name)
    print("Total number of bottom tweets: %s" % len(bottom_official["Content"]))
