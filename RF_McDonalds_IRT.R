#This program is being created to generate random forest predictions for McDonalds IRT data
#
...
#Generate predictions:
preds = predict(model_$finalModel, newdata = model.matrix(`Number of Likes` ~ topic.1 + topic.2 + topic.3 + topic.4 + topic.5, test_data))
...
#Generate predictions:
preds = predict(model_$finalModel, newdata = model.matrix(`Number of Likes` ~ has_link + topic.1 + topic.2 + topic.3 + topic.4 + topic.5, test_data))
...
#Generate predictions:
preds = predict(model_$finalModel, newdata = model.matrix(`Number of Likes` ~ has_hash + topic.1 + topic.2 + topic.3 + topic.4 + topic.5, test_data))
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(mtry=c(1:3))
model_ = train(`Number of Likes` ~ sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5,
               data = train_data, method = "rf",
               tuneGrid = grid, importance = TRUE)
...
#Generate predictions:
preds = predict(model_$finalModel, newdata = model.matrix(`Number of Likes` ~ sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5, test_data))
...
#Generate predictions:
preds = predict(model_$finalModel, newdata = model.matrix(`Number of Likes` ~ has_link + has_hash + topic.1 + topic.2 + topic.3 + topic.4 + topic.5, test_data))
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(mtry=c(1:3))
model_ = train(`Number of Likes` ~ has_link + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5,
               data = train_data, method = "rf",
               tuneGrid = grid, importance = TRUE)
...
#Generate predictions:
preds = predict(model_$finalModel, newdata = model.matrix(`Number of Likes` ~ has_link + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5, test_data))
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(mtry=c(1:3))
model_ = train(`Number of Likes` ~ has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5,
               data = train_data, method = "rf",
               tuneGrid = grid, importance = TRUE)
...
#Generate predictions:
preds = predict(model_$finalModel, newdata = model.matrix(`Number of Likes` ~ has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5, test_data))
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(mtry=c(1:3))
model_ = train(`Number of Likes` ~ has_link + has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5,
               data = train_data, method = "rf",
               tuneGrid = grid, importance = TRUE)
...
#Generate predictions:
preds = predict(model_$finalModel, newdata = model.matrix(`Number of Likes` ~ has_link + has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5, test_data))
...
#Generate predictions:
preds = predict(model_$finalModel, newdata = model.matrix(`Number of Retweets` ~ topic.1 + topic.2 + topic.3 + topic.4 + topic.5, test_data))
...
#Generate predictions:
preds = predict(model_$finalModel, newdata = model.matrix(`Number of Retweets` ~ has_link + topic.1 + topic.2 + topic.3 + topic.4 + topic.5, test_data))
...
#Generate predictions:
preds = predict(model_$finalModel, newdata = model.matrix(`Number of Retweets` ~ has_hash + topic.1 + topic.2 + topic.3 + topic.4 + topic.5, test_data))
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(mtry=c(1:3))
model_ = train(`Number of Retweets` ~ sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5,
               data = train_data, method = "rf",
               tuneGrid = grid, importance = TRUE)
...
#Generate predictions:
preds = predict(model_$finalModel, newdata = model.matrix(`Number of Retweets` ~ sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5, test_data))
...
#Generate predictions:
preds = predict(model_$finalModel, newdata = model.matrix(`Number of Retweets` ~ has_link + has_hash + topic.1 + topic.2 + topic.3 + topic.4 + topic.5, test_data))
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(mtry=c(1:3))
model_ = train(`Number of Retweets` ~ has_link + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5,
               data = train_data, method = "rf",
               tuneGrid = grid, importance = TRUE)
...
#Generate predictions:
preds = predict(model_$finalModel, newdata = model.matrix(`Number of Retweets` ~ has_link + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5, test_data))
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(mtry=c(1:3))
model_ = train(`Number of Retweets` ~ has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5,
               data = train_data, method = "rf",
               tuneGrid = grid, importance = TRUE)
...
#Generate predictions:
preds = predict(model_$finalModel, newdata = model.matrix(`Number of Retweets` ~ has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5, test_data))
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(mtry=c(1:3))
model_ = train(`Number of Retweets` ~ has_link + has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5,
               data = train_data, method = "rf",
               tuneGrid = grid, importance = TRUE)
...
#Generate predictions:
preds = predict(model_$finalModel, newdata = model.matrix(`Number of Retweets` ~ has_link + has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5, test_data))
...
write_xlsx(df, "C:\\Users\\Pendl\\OneDrive\\Documents\\TwitterProject\\ModelingResults_IRT\\Storage\\RF_McDonalds_IRT.xlsx")
