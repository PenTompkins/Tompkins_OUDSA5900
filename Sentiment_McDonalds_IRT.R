#This file is being created to run sentiment effect val. process over McDonalds IRT tweets
#
...
data = read_excel("C:/Users/Pendl/OneDrive/Documents/TwitterProject/OutlierFree_data/withSentiment/McDonalds_outsRem_ws.xlsx")
...
ggdensity(pos_tweets$logLikes,
          main = "McDonalds Positive: log(Likes)",
...
ggdensity(neut_tweets$logLikes,
          main = "McDonalds Neutral: log(Likes)",
...
ggdensity(neg_tweets$logLikes,
          main = "McDonalds Negative: log(Likes)",
...
ggdensity(pos_tweets$`Number of Retweets`,
          main = "McDonalds Positive: Retweets",
...
ggdensity(neut_tweets$`Number of Retweets`,
          main = "McDonalds Neutral: Retweets",
...
ggdensity(neg_tweets$`Number of Retweets`,
          main = "McDonalds Negative: Retweets",
          xlab = "Number of Retweets") #+ xlim(0, max(pos_tweets$`Number of Retweets`))
...
ggdensity(pos_tweets$logRetweets,
          main = "McDonalds Positive: log(Retweets)",
...
ggdensity(neut_tweets$logRetweets,
          main = "McDonalds Neutral: log(Retweets)",
...
ggdensity(neg_tweets$logRetweets,
          main = "McDonalds Negative: log(Retweets)",
