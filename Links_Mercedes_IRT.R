#This file is being created to run link effect val. process over Mercedes IRT tweets
#
...
ggdensity(link_tweets$logLikes,
          main = "Mercedes Linked: log(Likes)",
...
ggdensity(noLink_tweets$logLikes,
          main = "Mercedes No Link: log(Likes)",
          xlab = "log(Likes)")
...
ggdensity(noLink_tweets$`Number of Retweets`,
          main = "Mercedes No Link: Retweets",
