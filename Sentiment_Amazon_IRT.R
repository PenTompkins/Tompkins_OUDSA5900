#This file is being created to run sentiment effect val. process over Amazon IRT tweets
#
...
data = read_excel("C:/Users/Pendl/OneDrive/Documents/TwitterProject/OutlierFree_data/withSentiment/Amazon_outsRem_ws.xlsx")
...
ggdensity(pos_tweets$logLikes,
          main = "Amazon Positive: log(Likes)",
...
ggdensity(neg_tweets$logLikes,
          main = "Amazon Negative: log(Likes)",
...
ggdensity(pos_tweets$logRetweets,
          main = "Amazon Positive: log(Retweets)",
...
ggdensity(neut_tweets$logRetweets,
          main = "Amazon Neutral: log(Retweets)",
...
ggdensity(neg_tweets$logRetweets,
          main = "Amazon Negative: log(Retweets)",
