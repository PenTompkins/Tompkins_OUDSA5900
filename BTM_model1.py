# -*- coding: utf-8 -*-
#This file is being created to perform BTM topic modeling, with 'optimal' k supplied from 'estimate_BTM.py' and 'LongEstimateBTM.py' k values supplied, for each company
#
#
#Overall, this is program: 41
...
respath = 'C:\\Users\\Pendl\\OneDrive\\Documents\\TwitterProject\\Pictures\\BTMresults1\\'
resEnding = '_BTMresults1.xlsx'
optKs = [6, 8, 10, 10, 6, 10, 11, 6, 8, 10]
...
def perform_BTM(fpath, num_top):
    ...
    cleanGlish_tweets2["topic"] = [str(topics[i].argmax()) for i in range(len(cleanGlish_tweets2["Content"]))]
