# -*- coding: utf-8 -*-
#This file is being created to re-perform wordcount analysis over all datasets (hopefully all datasets)
#The ampersand issue and unicode issues should no longer be present in this analysis
#After corrected initial analysis is re-performed, further wordcount analysis will be applied as well
#Edit: Further wordcount analysis is performed in other files
#!!Note: This file has been 'retired' in favor of 'Dynamic_CountAll.py'
#Overall, this is program: 27
