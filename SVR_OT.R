#This file is being created to generate SVR preds for all OT data (besides Amazon)
#However, ultimately only BMW and Disney were successfully run through this file
...
#Read in train data:
train_data = read_excel("C:/Users/taylo/OneDrive/Documents/TwitterProject/Analysis_Data_OT/Train/BMW_train_OT.xlsx")

#Read in test data:
test_data = read_excel("C:/Users/taylo/OneDrive/Documents/TwitterProject/Analysis_Data_OT/Test/BMW_test_OT.xlsx")
...
write_xlsx(df, "C:\\Users\\taylo\\OneDrive\\Documents\\TwitterProject\\ModelingResults_OT\\Storage\\SVR_BMW_OT.xlsx")
...
#Read in train data:
train_data = read_excel("C:/Users/taylo/OneDrive/Documents/TwitterProject/Analysis_Data_OT/Train/Disney_train_OT.xlsx")

#Read in test data:
test_data = read_excel("C:/Users/taylo/OneDrive/Documents/TwitterProject/Analysis_Data_OT/Test/Disney_test_OT.xlsx")
...
write_xlsx(df, "C:\\Users\\taylo\\OneDrive\\Documents\\TwitterProject\\ModelingResults_OT\\Storage\\SVR_Disney_OT.xlsx")
...
model_ = tune(svm, `Number of Likes` ~ topic.1 + topic.2 + topic.3 + topic.4 + topic.5 +
                topic.6 + topic.7 + topic.8 + topic.9 + topic.10, data = train_data_xy,
              ranges = list(epsilon=seq(0.1,1,0.1), cost=c(1:100), gamma = c(0.001, 0.1)))
...
write_xlsx(df, "C:\\Users\\taylo\\OneDrive\\Documents\\TwitterProject\\ModelingResults_OT\\Storage\\SVR_Mercedes_OT.xlsx")
...
write_xlsx(df, "C:\\Users\\taylo\\OneDrive\\Documents\\TwitterProject\\ModelingResults_OT\\Storage\\SVR_Microsoft_OT.xlsx")
...
write_xlsx(df, "C:\\Users\\taylo\\OneDrive\\Documents\\TwitterProject\\ModelingResults_OT\\Storage\\SVR_Samsung_OT.xlsx")
...
write_xlsx(df, "C:\\Users\\taylo\\OneDrive\\Documents\\TwitterProject\\ModelingResults_OT\\Storage\\SVR_Toyota_OT.xlsx")
