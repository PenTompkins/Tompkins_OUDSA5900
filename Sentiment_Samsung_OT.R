#This file is being created to run sentiment effect val. process over Samsung OT tweets
#
...
data = read_excel("C:/Users/Pendl/OneDrive/Documents/TwitterProject/OutlierFree_data/withSentiment/Samsung_outsRem_ws.xlsx")
...
ggdensity(pos_tweets$logLikes,
          main = "Samsung Positive: log(Likes)",
...
ggdensity(pos_tweets$`Number of Retweets`,
          main = "Samsung Positive: Retweets",
...
ggdensity(neg_tweets$`Number of Retweets`,
          main = "Samsung Negative: Retweets",
          xlab = "Number of Retweets") + xlim(0, max(pos_tweets$`Number of Retweets`))
...
ggdensity(pos_tweets$logRetweets,
          main = "Samsung Positive: log(Retweets)",
...
ggdensity(neut_tweets$logRetweets,
          main = "Samsung Neutral: log(Retweets)",
...
ggdensity(neg_tweets$logRetweets,
          main = "Samsung Negative: log(Retweets)",
          xlab = "log(Retweets)") + xlim(min(pos_tweets$logRetweets), max(pos_tweets$logRetweets))
