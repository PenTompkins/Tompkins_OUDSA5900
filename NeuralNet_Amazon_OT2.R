#This program is being created to generate neural network predictions for Amazon OT data
#with sentiment added in
#
#Overall, this is program: 98
...
#Back transform predictions:
#First, set diffx and minx to values from transforming train data
...
set.seed(1)
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(18), layer2=c(1:4), layer3=c(0:2))
nn = train(scaledLikes ~ sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5 + topic.6 + topic.7 + topic.8 + topic.9 + topic.10 + topic.11 + topic.12 + topic.13 + topic.14 + topic.15 + topic.16, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(18), layer2=c(1:4), layer3=c(0:2))
nnt = train(scaledLikes2 ~ sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5 + topic.6 + topic.7 + topic.8 + topic.9 + topic.10 + topic.11 + topic.12 + topic.13 + topic.14 + topic.15 + topic.16, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
set.seed(1)
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(19), layer2=c(1:5), layer3=c(0:3))
nn = train(scaledLikes ~ has_link + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5 + topic.6 + topic.7 + topic.8 + topic.9 + topic.10 + topic.11 + topic.12 + topic.13 + topic.14 + topic.15 + topic.16, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(19), layer2=c(1:5), layer3=c(0:3))
nnt = train(scaledLikes2 ~ has_link + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5 + topic.6 + topic.7 + topic.8 + topic.9 + topic.10 + topic.11 + topic.12 + topic.13 + topic.14 + topic.15 + topic.16, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(19), layer2=c(1:5), layer3=c(0:3))
nn = train(scaledLikes ~ has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5 + topic.6 + topic.7 + topic.8 + topic.9 + topic.10 + topic.11 + topic.12 + topic.13 + topic.14 + topic.15 + topic.16, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(19), layer2=c(1:5), layer3=c(0:3))
nnt = train(scaledLikes2 ~ has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5 + topic.6 + topic.7 + topic.8 + topic.9 + topic.10 + topic.11 + topic.12 + topic.13 + topic.14 + topic.15 + topic.16, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
set.seed(1)
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(20), layer2=c(1:6), layer3=c(0:3))
nn = train(scaledLikes ~ has_link + has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5 + topic.6 + topic.7 + topic.8 + topic.9 + topic.10 + topic.11 + topic.12 + topic.13 + topic.14 + topic.15 + topic.16, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(20), layer2=c(1:6), layer3=c(0:3))
nnt = train(scaledLikes2 ~ has_link + has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5 + topic.6 + topic.7 + topic.8 + topic.9 + topic.10 + topic.11 + topic.12 + topic.13 + topic.14 + topic.15 + topic.16, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(18), layer2=c(1:4), layer3=c(0:2))
nn = train(scaledRetweets ~ sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5 + topic.6 + topic.7 + topic.8 + topic.9 + topic.10 + topic.11 + topic.12 + topic.13 + topic.14 + topic.15 + topic.16, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(18), layer2=c(1:4), layer3=c(0:2))
nnt = train(scaledRetweets2 ~ sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5 + topic.6 + topic.7 + topic.8 + topic.9 + topic.10 + topic.11 + topic.12 + topic.13 + topic.14 + topic.15 + topic.16, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(19), layer2=c(1:5), layer3=c(0:3))
nn = train(scaledRetweets ~ has_link + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5 + topic.6 + topic.7 + topic.8 + topic.9 + topic.10 + topic.11 + topic.12 + topic.13 + topic.14 + topic.15 + topic.16, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(19), layer2=c(1:5), layer3=c(0:3))
nnt = train(scaledRetweets2 ~ has_link + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5 + topic.6 + topic.7 + topic.8 + topic.9 + topic.10 + topic.11 + topic.12 + topic.13 + topic.14 + topic.15 + topic.16, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(19), layer2=c(1:5), layer3=c(0:3))
nn = train(scaledRetweets ~ has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5 + topic.6 + topic.7 + topic.8 + topic.9 + topic.10 + topic.11 + topic.12 + topic.13 + topic.14 + topic.15 + topic.16, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(19), layer2=c(1:5), layer3=c(0:3))
nnt = train(scaledRetweets2 ~ has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5 + topic.6 + topic.7 + topic.8 + topic.9 + topic.10 + topic.11 + topic.12 + topic.13 + topic.14 + topic.15 + topic.16, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(20), layer2=c(1:6), layer3=c(0:3))
nn = train(scaledRetweets ~ has_link + has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5 + topic.6 + topic.7 + topic.8 + topic.9 + topic.10 + topic.11 + topic.12 + topic.13 + topic.14 + topic.15 + topic.16, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(20), layer2=c(1:6), layer3=c(0:3))
nnt = train(scaledRetweets2 ~ has_link + has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5 + topic.6 + topic.7 + topic.8 + topic.9 + topic.10 + topic.11 + topic.12 + topic.13 + topic.14 + topic.15 + topic.16, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
write_xlsx(df, "C:\\Users\\Owner\\Documents\\Twitter Project\\ModelRes_OT\\NN_Amazon_OT2.xlsx")
write_xlsx(df2, "C:\\Users\\Owner\\Documents\\Twitter Project\\ModelRes_OT\\NN_Amazon_OTlayers2.xlsx")
