#This program is being created to generate neural network predictions for CocaCola IRT data
#
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(3), layer2=c(0:2), layer3=c(0:1))
nn = train(scaledLikes ~ has_link + topic.1 + topic.2, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(3), layer2=c(0:2), layer3=c(0:1))
nnt = train(scaledLikes2 ~ has_link + topic.1 + topic.2, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(3), layer2=c(0:2), layer3=c(0:1))
nn = train(scaledLikes ~ has_hash + topic.1 + topic.2, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(3), layer2=c(0:2), layer3=c(0:1))
nnt = train(scaledLikes2 ~ has_hash + topic.1 + topic.2, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(4), layer2=c(0:3), layer3=c(0:2))
nn = train(scaledLikes ~ has_link + has_hash + topic.1 + topic.2, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(4), layer2=c(0:3), layer3=c(0:2))
nnt = train(scaledLikes2 ~ has_link + has_hash + topic.1 + topic.2, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
set.seed(1)
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(5), layer2=c(0:4), layer3=c(0:3))
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(3), layer2=c(0:2), layer3=c(0:1))
nn = train(scaledRetweets ~ has_link + topic.1 + topic.2, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(3), layer2=c(0:2), layer3=c(0:1))
nnt = train(scaledRetweets2 ~ has_link + topic.1 + topic.2, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(3), layer2=c(0:2), layer3=c(0:1))
nn = train(scaledRetweets ~ has_hash + topic.1 + topic.2, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(3), layer2=c(0:2), layer3=c(0:1))
nnt = train(scaledRetweets2 ~ has_hash + topic.1 + topic.2, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(4), layer2=c(0:3), layer3=c(0:2))
nn = train(scaledRetweets ~ has_link + has_hash + topic.1 + topic.2, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(4), layer2=c(0:3), layer3=c(0:2))
nnt = train(scaledRetweets2 ~ has_link + has_hash + topic.1 + topic.2, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
write_xlsx(df, "C:\\Users\\Pendl\\OneDrive\\Documents\\TwitterProject\\ModelingResults_IRT\\Storage\\NN_CocaCola_IRT.xlsx")
write_xlsx(df2, "C:\\Users\\Pendl\\OneDrive\\Documents\\TwitterProject\\ModelingResults_IRT\\Storage\\NN_CocaCola_IRTlayers.xlsx")
