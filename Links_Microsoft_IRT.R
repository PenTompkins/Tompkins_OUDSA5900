#This file is being created to run link effect val. process over Microsoft IRT tweets
#
...
ggdensity(link_tweets$logLikes,
          main = "Microsoft Linked: log(Likes)",
          xlab = "log(Likes)") + xlim(min(noLink_tweets$logLikes), max(noLink_tweets$logLikes))

#Visualize dist. of log(likes) for noLink_tweets:
ggdensity(noLink_tweets$logLikes,
          main = "Microsoft No Link: log(Likes)",
          xlab = "log(Likes)")
...
ggdensity(link_tweets$`Number of Retweets`,
          main = "Microsoft Linked: Retweets",
...
ggdensity(noLink_tweets$`Number of Retweets`,
          main = "Microsoft No Link: Retweets",
...
ggdensity(noLink_tweets$logRetweets,
          main = "Microsoft No Link: log(RTs)",
          xlab = "log(Retweets)")
