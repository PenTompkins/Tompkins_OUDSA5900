#This file is being created to run hashtag effect val. process over Toyota OT tweets
#
...
ggdensity(Hashtag_tweets$logLikes,
          main = "Toyota Hashtags: log(Likes)",
...
ggdensity(noHashtag_tweets$logLikes,
          main = "Toyota No Hashtag: log(Likes)",
...
ggdensity(noHashtag_tweets$`Number of Retweets`,
          main = "Toyota No Hashtag: Retweets",
