# -*- coding: utf-8 -*-
#This file is an exact copy/paste of 'IBM_Sentiment.py'
#I just ran out of credits on my IBM lite account, so I made another. Only difference is the api key & credential info
...
#
#Overall, this is program: 35...35.2 really
...
#all_tweets.columns = ['Author', 'Content', 'Date', 'Language', 'Location', 'Number of Likes', 'Number of Retweets', 'In Reply To', 'Author Name', 'Author Description', 'Author Statuses Count', 'Author Favourites Count', 'Author Friends Count', 'Author Followers Count', 'Author Listed Count', 'Author Verified', 'Longitude', 'Latitude', 'num_hashtags']
