#This program is being created to generate random forest predictions for BMW OT data
...
write_xlsx(df, "C:\\Users\\Pendl\\OneDrive\\Documents\\TwitterProject\\ModelingResults_OT\\Storage\\RF_BMW_OT2.xlsx")
