#This program is being created to generate random forest predictions for Microsoft OT data
...
write_xlsx(df, "C:\\Users\\Pendl\\OneDrive\\Documents\\TwitterProject\\ModelingResults_OT\\Storage\\RF_Microsoft_OT2.xlsx")
