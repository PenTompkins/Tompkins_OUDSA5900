#This file is being created to run link effect val. process over Samsung OT tweets
#
...
ggdensity(noLink_tweets$logLikes,
          main = "Samsung No Link: log(Likes)",
          xlab = "log(Likes)")
...
#I believe so, not quite perfect
