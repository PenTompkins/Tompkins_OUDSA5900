#This file is being created to run BTM topic effect val. process over Samsung OT tweets
#
...
data = read_excel("C:/Users/Pendl/OneDrive/Documents/TwitterProject/Pictures/BTMresults_OT/Samsung_BTMresults_OT.xlsx")
