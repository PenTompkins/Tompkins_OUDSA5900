#This file is being created to run hashtag effect val. process over Disney OT tweets
#
...
data = read_excel("C:/Users/Pendl/OneDrive/Documents/TwitterProject/OutlierFree_data/Disney_outsRemoved.xlsx")
...
ggdensity(Hashtag_tweets$logLikes,
          main = "Disney Hashtags: log(Likes)",
...
ggdensity(noHashtag_tweets$logLikes,
          main = "Disney No Hashtag: log(Likes)",
          xlab = "log(Likes)")
...
ggdensity(noHashtag_tweets$`Number of Retweets`,
          main = "Disney No Hashtag: Retweets",
