# -*- coding: utf-8 -*-
#This file is being created to perform 'estimate_BTM.py' over remaining 8 datasets in one run
#Above file is being copied/pasted into here and created into a function
#
#Overall, this is program: 40
import pandas as pd
import numpy as np
...
files = ['CocaCola', 'Disney', 'Google', 'McDonalds', 'MercedesBenz', 'Microsoft', 'Samsung', 'Toyota']
figpath = 'C:\\Users\\Pendl\\OneDrive\\Documents\\TwitterProject\\Pictures\\BTMestimates\\'
