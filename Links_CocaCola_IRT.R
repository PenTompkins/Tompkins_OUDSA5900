#This file is being created to run link effect val. process over CocaCola IRT tweets
#
...
ggdensity(link_tweets$logLikes,
          main = "CocaCola Linked: log(Likes)",
...
ggdensity(noLink_tweets$logLikes,
          main = "CocaCola No Link: log(Likes)",
          xlab = "log(Likes)")
...
ggdensity(noLink_tweets$`Number of Retweets`,
          main = "CocaCola No Link: Retweets",
