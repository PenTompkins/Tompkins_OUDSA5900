# -*- coding: utf-8 -*-
#This file is being created to create final tweet topic assignments for companies having sufficient official tweets
#Thus, results from 'approximate_BTM_OT.py' will be used here
#I'm beginning by copying/pasting 'BTM_model2.py' in here, then making relevant changes (filepaths, k values, etc.)
#
...
files = ['Amazon', 'BMW', 'Disney', 'Google', 'MercedesBenz', 'Microsoft', 'Samsung', 'Toyota']
respath = 'C:\\Users\\Pendl\\OneDrive\\Documents\\TwitterProject\\Pictures\\BTMresults_OT\\'
resEnding = '_BTMresults_OT.xlsx'
#optKs = [6, 8, 10, 10, 6, 10, 11, 6, 8, 10] #optKs for BTM_model1.py
#optKs = [5, 4, 4, 16, 3, 6, 13, 15, 6, 19] #optKs for BTM_model2.py
optKs = [17, 3, 3, 19, 11, 3, 4, 14]
...
print("Performing BTM across all 8 OT companies took %s seconds" % global_run)
