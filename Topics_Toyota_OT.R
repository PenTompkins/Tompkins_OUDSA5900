#This file is being created to run BTM topic effect val. process over Toyota OT tweets
#
...
data = read_excel("C:/Users/Pendl/OneDrive/Documents/TwitterProject/Pictures/BTMresults_OT/Toyota_BTMresults_OT.xlsx")
...
df = tibble(gr = factor(c(rep("Zero", nt0), rep("One", nt1), rep("Two", nt2), rep("Three", nt3),
                          ...
                          rep("Eight", nt8), rep("Nine", nt9), rep("Ten", nt10), rep("Eleven", nt11),
                          rep("Twelve", nt12), rep("Thirteen", nt13))),
            obs = c(top0$`Number of Likes`, top1$`Number of Likes`, top2$`Number of Likes`, top3$`Number of Likes`,
                    ...
                    top12$`Number of Likes`, top13$`Number of Likes`))
...
df = tibble(gr = factor(c(rep("Zero", nt0), rep("One", nt1), rep("Two", nt2), rep("Three", nt3),
            ...
            obs = c(top0$`Number of Retweets`, top1$`Number of Retweets`, top2$`Number of Retweets`, top3$`Number of Retweets`,
                    ...
                    top12$`Number of Retweets`, top13$`Number of Retweets`))
...
df = tibble(gr = factor(c(rep("Zero", nt0), rep("One", nt1), rep("Two", nt2), rep("Three", nt3),
            ...
            obs = c(top0$logRetweets, top1$logRetweets, top2$logRetweets, top3$logRetweets,
                    ...
                    top12$logRetweets, top13$logRetweets))
