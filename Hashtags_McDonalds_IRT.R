#This file is being created to run hashtag effect val. process over McDonalds IRT tweets
#
...
data = read_excel("C:/Users/Pendl/OneDrive/Documents/TwitterProject/OutlierFree_data/McDonalds_outsRemoved.xlsx")
...
ggdensity(noHashtag_tweets$`Number of Likes`,
          main = "McDonalds No Hashtag: Likes",
...
ggdensity(Hashtag_tweets$logLikes,
          main = "McDonalds Hashtags: log(Likes)",
...
ggdensity(noHashtag_tweets$logLikes,
          main = "McDonalds No Hashtag: log(Likes)",
...
ggdensity(Hashtag_tweets$`Number of Retweets`,
          main = "McDonalds Hashtags: Retweets",
...
ggdensity(noHashtag_tweets$`Number of Retweets`,
          main = "McDonalds No Hashtag: Retweets",
