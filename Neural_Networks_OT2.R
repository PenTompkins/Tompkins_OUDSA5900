#This file is being created to perform NN predictions for all OT data (besides Amazon)
#With sentiment added in
#However, ultimately only BMW and Disney successfully ran through here
...
#First, we must one-hot encode topic, as it's a categorical variable
...
set.seed(1)
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(4), layer2=c(0:2), layer3=c(0:1))
nn = train(scaledLikes ~ sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(4), layer2=c(0:2), layer3=c(0:1))
nnt = train(scaledLikes2 ~ sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
nn = train(scaledLikes ~ has_link + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(5), layer2=c(0:3), layer3=c(0:2))
nnt = train(scaledLikes2 ~ has_link + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(5), layer2=c(0:3), layer3=c(0:2))
nn = train(scaledLikes ~ has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(5), layer2=c(0:3), layer3=c(0:2))
nnt = train(scaledLikes2 ~ has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
set.seed(1)
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(6), layer2=c(0:3), layer3=c(0:2))
nn = train(scaledLikes ~ has_link + has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(6), layer2=c(0:3), layer3=c(0:2))
nnt = train(scaledLikes2 ~ has_link + has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(4), layer2=c(0:2), layer3=c(0:1))
nn = train(scaledRetweets ~ sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(4), layer2=c(0:2), layer3=c(0:1))
nnt = train(scaledRetweets2 ~ sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(5), layer2=c(0:3), layer3=c(0:2))
nn = train(scaledRetweets ~ has_link + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(5), layer2=c(0:3), layer3=c(0:2))
nnt = train(scaledRetweets2 ~ has_link + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(5), layer2=c(0:3), layer3=c(0:2))
nn = train(scaledRetweets ~ has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(5), layer2=c(0:3), layer3=c(0:2))
nnt = train(scaledRetweets2 ~ has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(6), layer2=c(0:3), layer3=c(0:2))
nn = train(scaledRetweets ~ has_link + has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(6), layer2=c(0:3), layer3=c(0:2))
nnt = train(scaledRetweets2 ~ has_link + has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
write_xlsx(df, "C:\\Users\\Owner\\Documents\\Twitter Project\\ModelingResults_IRT\\Storage\\NN_BMW_OT2.xlsx")
write_xlsx(df2, "C:\\Users\\Owner\\Documents\\Twitter Project\\ModelingResults_IRT\\Storage\\NN_BMW_OTlayers2.xlsx")
...
write_xlsx(df, "C:\\Users\\Owner\\Documents\\Twitter Project\\ModelingResults_IRT\\Storage\\NN_Disney_OT2.xlsx")
write_xlsx(df2, "C:\\Users\\Owner\\Documents\\Twitter Project\\ModelingResults_IRT\\Storage\\NN_Disney_OTlayers2.xlsx")
...
set.seed(1)
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(12), layer2=c(0:6), layer3=c(0:3))
nn = train(scaledLikes ~ sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5 + topic.6 + topic.7 + topic.8 + topic.9 + topic.10, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(12), layer2=c(0:6), layer3=c(0:3))
nnt = train(scaledLikes2 ~ sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5 + topic.6 + topic.7 + topic.8 + topic.9 + topic.10, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
set.seed(1)
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(13), layer2=c(0:6), layer3=c(0:3))
nn = train(scaledLikes ~ has_link + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5 + topic.6 + topic.7 + topic.8 + topic.9 + topic.10, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(13), layer2=c(0:6), layer3=c(0:3))
nnt = train(scaledLikes2 ~ has_link + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5 + topic.6 + topic.7 + topic.8 + topic.9 + topic.10, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(13), layer2=c(0:6), layer3=c(0:3))
nn = train(scaledLikes ~ has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5 + topic.6 + topic.7 + topic.8 + topic.9 + topic.10, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(13), layer2=c(0:6), layer3=c(0:3))
nnt = train(scaledLikes2 ~ has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5 + topic.6 + topic.7 + topic.8 + topic.9 + topic.10, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
set.seed(1)
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(14), layer2=c(0:7), layer3=c(0:4))
nn = train(scaledLikes ~ has_link + has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5 + topic.6 + topic.7 + topic.8 + topic.9 + topic.10, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(14), layer2=c(0:7), layer3=c(0:4))
nnt = train(scaledLikes2 ~ has_link + has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5 + topic.6 + topic.7 + topic.8 + topic.9 + topic.10, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(12), layer2=c(0:6), layer3=c(0:3))
nn = train(scaledRetweets ~ sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5 + topic.6 + topic.7 + topic.8 + topic.9 + topic.10, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(12), layer2=c(0:6), layer3=c(0:3))
nnt = train(scaledRetweets2 ~ sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5 + topic.6 + topic.7 + topic.8 + topic.9 + topic.10, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(13), layer2=c(0:6), layer3=c(0:3))
nn = train(scaledRetweets ~ has_link + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5 + topic.6 + topic.7 + topic.8 + topic.9 + topic.10, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(13), layer2=c(0:6), layer3=c(0:3))
nnt = train(scaledRetweets2 ~ has_link + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5 + topic.6 + topic.7 + topic.8 + topic.9 + topic.10, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(13), layer2=c(0:6), layer3=c(0:3))
nn = train(scaledRetweets ~ has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5 + topic.6 + topic.7 + topic.8 + topic.9 + topic.10, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(13), layer2=c(0:6), layer3=c(0:3))
nnt = train(scaledRetweets2 ~ has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5 + topic.6 + topic.7 + topic.8 + topic.9 + topic.10, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(14), layer2=c(0:7), layer3=c(0:4))
nn = train(scaledRetweets ~ has_link + has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5 + topic.6 + topic.7 + topic.8 + topic.9 + topic.10, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(14), layer2=c(0:7), layer3=c(0:4))
nnt = train(scaledRetweets2 ~ has_link + has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3 + topic.4 + topic.5 + topic.6 + topic.7 + topic.8 + topic.9 + topic.10, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
write_xlsx(df, "C:\\Users\\Owner\\Documents\\Twitter Project\\ModelingResults_IRT\\Storage\\NN_Mercedes_OT2.xlsx")
write_xlsx(df2, "C:\\Users\\Owner\\Documents\\Twitter Project\\ModelingResults_IRT\\Storage\\NN_Mercedes_OTlayers2.xlsx")
...
write_xlsx(df, "C:\\Users\\Owner\\Documents\\Twitter Project\\ModelingResults_IRT\\Storage\\NN_Microsoft_OT2.xlsx")
write_xlsx(df2, "C:\\Users\\Owner\\Documents\\Twitter Project\\ModelingResults_IRT\\Storage\\NN_Microsoft_OTlayers2.xlsx")
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(5), layer2=c(0:3), layer3=c(0:2))
nn = train(scaledLikes ~ sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(5), layer2=c(0:3), layer3=c(0:2))
nnt = train(scaledLikes2 ~ sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(6), layer2=c(0:3), layer3=c(0:2))
nn = train(scaledLikes ~ has_link + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(6), layer2=c(0:3), layer3=c(0:2))
nnt = train(scaledLikes2 ~ has_link + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(6), layer2=c(0:3), layer3=c(0:2))
nn = train(scaledLikes ~ has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(6), layer2=c(0:3), layer3=c(0:2))
nnt = train(scaledLikes2 ~ has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
nn = train(scaledLikes ~ has_link + has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(7), layer2=c(0:4), layer3=c(0:2))
nnt = train(scaledLikes2 ~ has_link + has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(5), layer2=c(0:3), layer3=c(0:2))
nn = train(scaledRetweets ~ sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(5), layer2=c(0:3), layer3=c(0:2))
nnt = train(scaledRetweets2 ~ sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(6), layer2=c(0:3), layer3=c(0:2))
nn = train(scaledRetweets ~ has_link + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(6), layer2=c(0:3), layer3=c(0:2))
nnt = train(scaledRetweets2 ~ has_link + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(6), layer2=c(0:3), layer3=c(0:2))
nn = train(scaledRetweets ~ has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(6), layer2=c(0:3), layer3=c(0:2))
nnt = train(scaledRetweets2 ~ has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(7), layer2=c(0:4), layer3=c(0:2))
nn = train(scaledRetweets ~ has_link + has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3, data = train_data, trControl=control, method="neuralnet",
           tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(7), layer2=c(0:4), layer3=c(0:2))
nnt = train(scaledRetweets2 ~ has_link + has_hash + sent_cat.Neutral + sent_cat.Negative + topic.1 + topic.2 + topic.3, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid, act.fct = "tanh")
print(nnt)
...
write_xlsx(df, "C:\\Users\\Owner\\Documents\\Twitter Project\\ModelingResults_IRT\\Storage\\NN_Samsung_OT2.xlsx")
write_xlsx(df2, "C:\\Users\\Owner\\Documents\\Twitter Project\\ModelingResults_IRT\\Storage\\NN_Samsung_OTlayers2.xlsx")
