#This file is being created to run hashtag effect val. process over Samsung OT tweets
#
...
data = read_excel("C:/Users/Pendl/OneDrive/Documents/TwitterProject/OutlierFree_data/Samsung_outsRemoved.xlsx")
...
ggdensity(Hashtag_tweets$logLikes,
          main = "Samsung Hashtags: log(Likes)",
...
ggdensity(noHashtag_tweets$logLikes,
          main = "Samsung No Hashtag: log(Likes)",
          xlab = "log(Likes)") + xlim(min(Hashtag_tweets$logLikes), max(Hashtag_tweets$logLikes))
...
ggdensity(Hashtag_tweets$`Number of Retweets`,
          main = "Samsung Hashtags: Retweets",
...
ggdensity(noHashtag_tweets$`Number of Retweets`,
          main = "Samsung No Hashtag: Retweets",
...
ggdensity(Hashtag_tweets$logRetweets,
          main = "Samsung Hashtags: log(RTs)",
          xlab = "log(Retweets)")

#Visualize dist. of log(retweets) for noHashtag_tweets:
ggdensity(noHashtag_tweets$logRetweets,
          main = "Samsung No Hashtag: log(RTs)",
          xlab = "log(Retweets)") + xlim(min(Hashtag_tweets$logRetweets), max(Hashtag_tweets$logRetweets))
