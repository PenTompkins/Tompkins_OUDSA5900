# -*- coding: utf-8 -*-
#This file is being created to first perform basic sentiment analysis, followed by Biterm Topic Model (BTM) topic analysis
#Sentiment analysis link: https://towardsdatascience.com/text-analysis-basics-in-python-443282942ec5
#BTM link: https://pypi.org/project/biterm/
#!Edit: This file's sole purpose is now topic modeling. I'll keep the sentiment code in because it's not affecting anything and is relatively quick
#However, sentiment analysis is now being transferred over to 'Sentiment_Subjectivity.py'
#!!Edit: 'Sentiment_Subjectivity.py' has now been retired in favor of 'IBM_Sentiment.py'
#
#Overall, this is program: 33
