...
set.seed(1)
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(16), layer2=c(0:8), layer3=c(0:2))
nn = train(scaledLikes ~ topic.1 + topic.2 + topic.3 +
              ...
              topic.14 + topic.15 + topic.16, data = train_data, trControl=control, method="neuralnet",
            tuneGrid = grid)
print(nn)
#Generate predictions:
preds_nn = compute(nn$finalModel, test_data)$net.result
...
set.seed(1)
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(17), layer2=c(0:8), layer3=c(0:1))
...
set.seed(1)
control = trainControl(method = "repeatedcv", number = 10, repeats = 3)
grid = expand.grid(layer1=c(18), layer2=c(0:9), layer3=c(0:2))
...
write_xlsx(df, "C:\\Users\\Pendl\\OneDrive\\Documents\\TwitterProject\\ModelingResults_OT\\Storage\\NN_Amazon_OT.xlsx")
write_xlsx(df2, "C:\\Users\\Pendl\\OneDrive\\Documents\\TwitterProject\\ModelingResults_OT\\Storage\\NN_Amazon_OTlayers.xlsx")
