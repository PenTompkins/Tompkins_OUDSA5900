#This program is being created to generate random forest predictions for Samsung OT data
...
write_xlsx(df, "C:\\Users\\Pendl\\OneDrive\\Documents\\TwitterProject\\ModelingResults_OT\\Storage\\RF_Samsung_OT2.xlsx")
