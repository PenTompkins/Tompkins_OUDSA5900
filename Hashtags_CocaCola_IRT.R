#This file is being created to run hashtag effect val. process over CocaCola IRT tweets
#
...
data = read_excel("C:/Users/Pendl/OneDrive/Documents/TwitterProject/OutlierFree_data/CocaCola_outsRemoved.xlsx")
...
ggdensity(noHashtag_tweets$`Number of Likes`,
          main = "CocaCola No Hashtag: Likes",
...
ggdensity(Hashtag_tweets$logLikes,
          main = "CocaCola Hashtags: log(Likes)",
...
ggdensity(noHashtag_tweets$logLikes,
          main = "CocaCola No Hashtag: log(Likes)",
          xlab = "log(Likes)") + xlim(min(noHashtag_tweets$logLikes), max(Hashtag_tweets$logLikes))
...
ggdensity(Hashtag_tweets$`Number of Retweets`,
          main = "CocaCola Hashtags: Retweets",
...
ggdensity(noHashtag_tweets$`Number of Retweets`,
          main = "CocaCola No Hashtag: Retweets",
...
ggdensity(Hashtag_tweets$logRetweets,
          main = "CocaCola Hashtags: log(RTs)",
          xlab = "log(Retweets)")

#Visualize dist. of log(retweets) for noHashtag_tweets:
ggdensity(noHashtag_tweets$logRetweets,
          main = "CocaCola No Hashtag: log(RTs)",
          xlab = "log(Retweets)") + xlim(min(noHashtag_tweets$logRetweets), max(Hashtag_tweets$logRetweets))
