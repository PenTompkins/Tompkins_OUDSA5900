#This file is being created to run sentiment effect val. process over Microsoft OT tweets
#
...
data = read_excel("C:/Users/Pendl/OneDrive/Documents/TwitterProject/OutlierFree_data/withSentiment/Microsoft_outsRem_ws.xlsx")
...
ggdensity(pos_tweets$logLikes,
          main = "Microsoft Positive: log(Likes)",
          xlab = "log(Likes)") + xlim(min(pos_tweets$logLikes), max(neut_tweets$logLikes))

#Visualize dist. of log(likes) for Neutral tweets:
ggdensity(neut_tweets$logLikes,
          main = "Microsoft Neutral: log(Likes)",
          xlab = "log(Likes)") + xlim(min(neut_tweets$logLikes), max(neut_tweets$logLikes))

#Visualize dist. of log(likes) for Negative tweets:
ggdensity(neg_tweets$logLikes,
          main = "Microsoft Negative: log(Likes)",
          xlab = "log(Likes)") + xlim(min(neut_tweets$logLikes), max(neut_tweets$logLikes))
...
ggdensity(tweets$logRetweets,
          main = "Microsoft OT: log(Retweets)",
          xlab = "log(Retweets)")
...
ggdensity(pos_tweets$`Number of Retweets`,
          main = "Microsoft Positive: Retweets",
...
ggdensity(neut_tweets$`Number of Retweets`,
          main = "Microsoft Neutral: Retweets",
...
ggdensity(neg_tweets$`Number of Retweets`,
          main = "Microsoft Negative: Retweets",
          xlab = "Number of Retweets") + xlim(0, max(neut_tweets$`Number of Retweets`))
...
ggdensity(pos_tweets$logRetweets,
          main = "Microsoft Positive: log(Retweets)",
...
ggdensity(neut_tweets$logRetweets,
          main = "Microsoft Neutral: log(Retweets)",
          xlab = "log(Retweets)") #+ xlim(min(neut_tweets$logRetweets), max(neg_tweets$logRetweets))

#Visualize dist. of log(Retweets) for Negative tweets:
ggdensity(neg_tweets$logRetweets,
          main = "Microsoft Negative: log(Retweets)",
          xlab = "log(Retweets)") + xlim(min(neg_tweets$logRetweets), max(neut_tweets$logRetweets))
