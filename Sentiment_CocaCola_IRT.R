#This file is being created to run sentiment effect val. process over CocaCola IRT tweets
#
...
data = read_excel("C:/Users/Pendl/OneDrive/Documents/TwitterProject/OutlierFree_data/withSentiment/CocaCola_outsRem_ws.xlsx")
...
ggdensity(pos_tweets$logLikes,
          main = "CocaCola Positive: log(Likes)",
...
ggdensity(neut_tweets$logLikes,
          main = "CocaCola Neutral: log(Likes)",
...
ggdensity(neg_tweets$logLikes,
          main = "CocaCola Negative: log(Likes)",
...
ggdensity(tweets$logRetweets,
          main = "CocaCola IRT: log(Retweets)",
          xlab = "log(Retweets)")
...
ggdensity(pos_tweets$`Number of Retweets`,
          main = "CocaCola Positive: Retweets",
...
ggdensity(neut_tweets$`Number of Retweets`,
          main = "CocaCola Neutral: Retweets",
...
ggdensity(neg_tweets$`Number of Retweets`,
          main = "CocaCola Negative: Retweets",
          xlab = "Number of Retweets") + xlim(0, max(pos_tweets$`Number of Retweets`))
...
ggdensity(pos_tweets$logRetweets,
          main = "CocaCola Positive: log(Retweets)",
          xlab = "log(Retweets)") + xlim(min(neut_tweets$logRetweets), max(neut_tweets$logRetweets))

#Visualize dist. of log(Retweets) for Neutral tweets:
ggdensity(neut_tweets$logRetweets,
          main = "CocaCola Neutral: log(Retweets)",
...
ggdensity(neg_tweets$logRetweets,
          main = "CocaCola Negative: log(Retweets)",
          xlab = "log(Retweets)") + xlim(min(neut_tweets$logRetweets), max(neut_tweets$logRetweets))
