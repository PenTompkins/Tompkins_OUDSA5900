#This file is being created to run hashtag effect val. process over Google IRT tweets
#
...
ggdensity(Hashtag_tweets$logLikes,
          main = "Google Hashtags: log(Likes)",
...
ggdensity(noHashtag_tweets$logLikes,
          main = "Google No Hashtag: log(Likes)",
...
ggdensity(noHashtag_tweets$`Number of Retweets`,
          main = "Google No Hashtag: Retweets",
