#This file is being created to run sentiment effect val. process over Disney OT tweets
#
...
data = read_excel("C:/Users/Pendl/OneDrive/Documents/TwitterProject/OutlierFree_data/withSentiment/Disney_outsRem_ws.xlsx")
...
ggdensity(pos_tweets$logLikes,
          main = "Disney Positive: log(Likes)",
...
ggdensity(pos_tweets$logRetweets,
          main = "Disney Positive: log(Retweets)",
...
ggdensity(neut_tweets$logRetweets,
          main = "Disney Neutral: log(Retweets)",
...
ggdensity(neg_tweets$logRetweets,
          main = "Disney Negative: log(Retweets)",
          xlab = "log(Retweets)") + xlim(min(neut_tweets$logRetweets), max(neg_tweets$logRetweets))
