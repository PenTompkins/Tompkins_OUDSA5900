#This file is being created to run hashtag effect val. process over BMW IRT tweets
#
...
data = read_excel("C:/Users/Pendl/OneDrive/Documents/TwitterProject/OutlierFree_data/BMW_outsRemoved.xlsx")
