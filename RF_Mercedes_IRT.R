#This program is being created to generate random forest predictions for Mercedes IRT data
#
...
write_xlsx(df, "C:\\Users\\Pendl\\OneDrive\\Documents\\TwitterProject\\ModelingResults_IRT\\Storage\\RF_Mercedes_IRT.xlsx")
