#This file is being created to run sentiment effect val. process over Mercedes IRT tweets
#
...
data = read_excel("C:/Users/Pendl/OneDrive/Documents/TwitterProject/OutlierFree_data/withSentiment/MercedesBenz_outsRem_ws.xlsx")
...
ggdensity(pos_tweets$logLikes,
          main = "Mercedes Positive: log(Likes)",
...
ggdensity(neut_tweets$logLikes,
          main = "Mercedes Neutral: log(Likes)",
          xlab = "log(Likes)") + xlim(min(neut_tweets$logLikes), max(pos_tweets$logLikes))

#Visualize dist. of log(likes) for Negative tweets:
ggdensity(neg_tweets$logLikes,
          main = "Mercedes Negative: log(Likes)",
...
ggdensity(tweets$logRetweets,
          main = "Mercedes IRT: log(Retweets)",
          xlab = "log(Retweets)")
...
ggdensity(pos_tweets$`Number of Retweets`,
          main = "Mercedes Positive: Retweets",
...
ggdensity(neut_tweets$`Number of Retweets`,
          main = "Mercedes Neutral: Retweets",
...
ggdensity(neg_tweets$`Number of Retweets`,
          main = "Mercedes Negative: Retweets",
          xlab = "Number of Retweets") + xlim(0, max(pos_tweets$`Number of Retweets`))
...
ggdensity(pos_tweets$logRetweets,
          main = "Mercedes Positive: log(Retweets)",
...
ggdensity(neut_tweets$logRetweets,
          main = "Mercedes Neutral: log(Retweets)",
...
ggdensity(neg_tweets$logRetweets,
          main = "Mercedes Negative: log(Retweets)",
